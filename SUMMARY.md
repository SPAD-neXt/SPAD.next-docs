...
* [Serial Interface](extending-and-apis/serial-connection/README.md)
  ...
  * [Serial: Configuration (1)](extending-and-apis/serial-connection/command-1/README.md)
    ...
    * [Command: 1,OPTION](extending-and-apis/serial-connection/command-1/command-1-option.md)
    * [Command: 1,PROFILE](extending-and-apis/serial-connection/command-1/command-1-profile.md)
    * [Command: 1,OUTPUT](extending-and-apis/serial-connection/command-1/command-1-output/README.md)
      * [Type = LED](extending-and-apis/serial-connection/command-1/command-1-output/type-led.md)
      * [Type = DISPLAY](extending-and-apis/serial-connection/command-1/command-1-output/type-display.md)
    * [Command: 1,INPUT](extending-and-apis/serial-connection/command-1/command-1-input/README.md)
      * [Type = AXIS](extending-and-apis/serial-connection/command-1/command-1-input/type-axis.md)
      * [Type = ENCODER](extending-and-apis/serial-connection/command-1/command-1-input/type-encoder.md)
      * [Type = PUSHBUTTON](extending-and-apis/serial-connection/command-1/command-1-input/type-pushbutton.md)
      * [Type = SWITCH](extending-and-apis/serial-connection/command-1/command-1-input/type-switch.md)
  * [Serial: Events (CMDID 2)](extending-and-apis/serial-connection/command-2.md)
