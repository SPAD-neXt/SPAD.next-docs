...
* [Device Interface](extending-and-apis/serial-connection/README.md)
  ...
  * [Device Configuration-Phase](extending-and-apis/serial-connection/device-configuration-phase/README.md)
    * [Device options](extending-and-apis/serial-connection/device-configuration-phase/device-options.md)
    ...
    * [Device OUTPUT Configuration](extending-and-apis/serial-connection/device-configuration-phase/device-output-configuration.md)
    * [Device INPUT configuration](extending-and-apis/serial-connection/device-configuration-phase/device-input-configuration/README.md)
      * [Type = AXIS](extending-and-apis/serial-connection/device-configuration-phase/device-input-configuration/type-axis.md)
      * [Type = ENCODER](extending-and-apis/serial-connection/device-configuration-phase/device-input-configuration/type-encoder.md)
      * [Type = PUSHBUTTON](extending-and-apis/serial-connection/device-configuration-phase/device-input-configuration/type-pushbutton.md)
      * [Type = SWITCH](extending-and-apis/serial-connection/device-configuration-phase/device-input-configuration/type-switch.md)
  ...
  * [Device LED Update (6)](extending-and-apis/serial-connection/device-led-update-6.md)
  * [Device Display Update (7)](extending-and-apis/serial-connection/device-display-update-7.md)
  * [Device Virtual Power](extending-and-apis/serial-connection/device-virtual-power.md)
